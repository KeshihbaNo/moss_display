...
A previously extracted MOSS GIF ![Original GIF](jump_sequence.gif) and sound file have been converted to LUTs and are being played on repeat.
...
Special thanks to **swisschips** for making this project possible. ![Moss](MOSS_SMOL.png)
